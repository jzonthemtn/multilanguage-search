...
import com.mtnfog.LangTranslateRest;

public class LangTranslateRestTest {

    private TestRunner runner;

    @Before
    public void init() {    	
    	runner = TestRunners.newTestRunner(LangTranslateRest.class);
    }

    @Ignore("Requires Apache Joshua en-de REST server running.")
    @Test
    public void translate() throws IOException {

        InputStream content = new ByteArrayInputStream("birthday".getBytes());
